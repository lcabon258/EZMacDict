...
class Make_Dict_XML(object):
    ...
    css_P_color="rgb(97,71,46)"):
        ...
        self.perf_html=oph.join(self.workpath,"{}_pref.html".format(Dict_Name))
        self.xslName=oph.join(self.workpath,"{}.xsl".format(Dict_Name))
...
""".format(self.css_H1_color,self.css_P_color))
    ...
    def Write_pref(self):
        with io.open(self.perf_html,"wt",encoding="utf-8") as _pref:
            _pref.write("""<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.1//EN" "http://www.w3.org/TR/xhtml11/DTD/xhtml11.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<meta http-equiv="content-type" content="text/html; charset=UTF-8" />
	</head>
	<body>
    <p>Name of dictionary : {} </p>
    <hr/>
    <p>Python script written by CWSun 2017.02</p>
    <p>blog : <a href="https://lcarbon.idv.tw">Digiologist</a>
	</body>
</html>""".format(self.dname))
            _pref.flush()
        print("[OK] File created : {}".format(self.perf_html))
    
    def Write_xsl(self):
        with io.open(self.xslName,"wt",encoding="utf-8") as _xsl:
            _xsl.write("""<?xml version="1.0" encoding="UTF-8"?>
...
<xsl:template match="@*|node()">
	<xsl:copy>
		<xsl:apply-templates select="@*|node()" />
            ...
            _xsl.flush()
        print("[OK] File created : {}".format(self.xslName))
